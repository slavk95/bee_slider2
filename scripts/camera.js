...
;(function($){$.fn.camera = function(opts, showBlock) {
...
////////callbacks
		 ...
		 //$( function() {
		 		...
		 		$( "#slider-range-max" ).slider({
                  ...
                  slide: function( event, ui ) {
                  	...
                  	if (flagForSlide && !isNaN(ui.value)) {
                  		console.log(ui.value);	               
	...
	$('.camera_caption',wrap).each(function(){
		$(this).wrapInner(function(){
			//return '<div />'+'id=' +countForWrap+'';
			return '<div id="' + "divWrap"+countForWrap +'"/>';	
		});
	...
	var loopMove;
	var cameraContentCounter=0;
	for (loopMove=0;loopMove<amountSlide;loopMove++)
	{
		$('.cameraContents',content).append('<div class="cameraContent" id="cameraContent'+cameraContentCounter+'" />');
				...
				$.each(allThumbs, function(i, val) {
					if($('> div', elem).eq(i).attr('data-thumb')!='' && i<allThumbs.length-1) {
						...
						var thumbUrl = "../images/icon/" + i + ".png";
							newImg = new Image();
						newImg.src = thumbUrl;
						$('ul',thumbs).append('<li class="item rslides1_s' + (i+1) + ' rslides_here pix_thumb pix_thumb_'+i+'" id="elem'+i+'" />');
						$('li.pix_thumb_'+i,thumbs).append($(newImg).attr('class','camera_thumb'+i));
					}
				});
			} else {
				$.each(allThumbs, function(i, val) {
					if($('> div', elem).eq(i).attr('data-thumb')!='') {
						...
						// $('li.pag_nav_'+i+' > img').attr("id","icon" + i);
	...
	function nextSlide(navSlide){ 
		console.log("nav " + navSlide);
		console.log("prev " + previousSlide);


		if (navSlide !== undefined) {
			console.log("!====");
			$("#slider-range-max").slider("value",navSlide);			
			previousSlide = navSlide;
			$("#slider3-pager").css("display","none");
		}
		if (navSlide == undefined) {
			$("#slider-range-max").slider("value",++previousSlide);
			$("#slider3-pager").css("display","none");
		}
		if (previousSlide > 19) {
